...
La décomposition de la $F_{ST}$, en une somme d'effets locus-spécifique et population-spécifique, permet d'identifier les locus à forte $F_{ST}$ qui présentent un effet qui n'est pas partagé par les autres locus. Le modèle $F$ ne prend pas en compte la structure hiérarchique [@foll2014widespread]. Ce modèle est implémenté dans le logiciel Bayescan.
...
(ref:correlogram-cap) À gauche une matrice d'apparentement génétique interpopulationnelle calculée à partir de la simulation d'un modèle en îles à trois populations. À droite une matrice d'apparentement génétique interindividuelle. Ces matrices d'apparentement ont été estimées à partir d'une simulation d'un modèle en îles à trois populations.
...
```{proof, echo=TRUE}
En reprenant les notations de la proposition \@ref(prp:udelta) et en rappelant que $p_k = \frac{\sum_{i=1}^n \delta_{ki} G_{ij}}{\sum_{i=1}^n 2\delta_{ki}}$,
\begin{equation}
  \begin{split}
...
```{r ndf-fig1, results='asis', fig.cap='(ref:ndf-fig1-cap)', out.width="50%"}
...
```{r ndf-fig2, results='asis', fig.cap='(ref:ndf-fig2-cap)', out.width="50%"}
...
```{r ndf-fig4, results='asis', fig.cap='(ref:ndf-fig4-cap)', out.width="50%"}
...
```{r ndf-fig5, results='asis', fig.cap='(ref:ndf-fig5-cap)', out.width="50%"}
...
```{r ndf-fig6, results='asis', fig.cap='(ref:ndf-fig6-cap)', out.width="50%"}
...
```{r ndf-fig7, results='asis', fig.cap='(ref:ndf-fig7-cap)', out.width="50%"}
