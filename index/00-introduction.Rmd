...
Les SNPs présentant la différenciation la plus élevée sont localisés sur le facteur de transcription EPAS1 connu pour être activé en condition d'hypoxie. À la suite de ces scans de différenciation, il a été montré à l'aide de la statistique $D$ (Table \@ref(tab:tibetan-introgression)) que les variants adaptatifs sur EPAS1 ont été transmis grâce à l'introgression issue de l'Homme de Denisova [@hu2017evolutionary].

(ref:tibetan-introgression-cap) Scan génomique pour l'introgression chez les tibétains réalisé par @hu2017evolutionary utilisant la statistique $D$ ($D^{*}$ correspond à la normalisation de la statistique $D$ que nous introduirons dans le chapitre 3). La colonne de droite contient le nom des gènes potentiellement hérités de l'Homme de Denisova. Nous retrouvons dans cette liste le gène EPAS1 [@hu2017evolutionary].
