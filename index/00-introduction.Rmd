...
En biologie évolutive, la sélection naturelle est la force évolutive qui tend à préserver les allèles conférant des avantages quant à la viabilité ou la fertilité d'un individu. Elle agit sur les traits qui sont héritables. La grande majorité de ces traits sont transmis aux descendants en suivant le mécanisme d'hérédité génétique. 
...
Un caractère (par exemple un variant allélique) peut être sélectionné au sein d'une population de différentes manières : 
...
(ref:tibetan-introgression-cap) Scan génomique pour l'introgression utilisant la statistique $D$ ($D^{*}$ correspond à la normalisation de la statistique $D$ que nous introduirons dans le chapitre. Nous retrouvons bien EPAS1 dans la liste des gènes hérités de l'Homme de Denisova) [@hu2017evolutionary].
