...
La dérive génétique est un concept essentiel en génétique des populations, et correspond   . Le principe de dérive génétique est illustré en figure \@ref(fig:drift), à l'aide du modèle de Wright-Fisher tel qu'il est présenté dans l'ouvrage *Population Genetics* [@gillespie2010population].
...
L'adaptivité d'un caractère peut survenir de différentes manières :
